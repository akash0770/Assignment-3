...
public class MemberTest {
	...
	public void setUp() throws Exception {
		mem1 = new Member("akashdeep", "Singh", "12345", "sunnyohi@gmail.com", 101);
		mem2 = new Member("amritesh", "moudgil", "54321", "amoudgil@gmail.com", 102);
		mem3 = new Member("navinder", "atwaal", "98765", "natwal@gmail@gmail.com", 103);
	...
	public final void testGetFirstName() {
		...
		assertEquals("Matching First Name", "akash", fName);
	}
	...
	public final void testGetLastName() {
		...
		assertEquals("Matching Last Name", "sadiora", lName);
	}
	...
	public final void testGetEmailAddress() {
		...
		assertEquals("Matching email", "sunnyohi@gmail.com", email);
	}
