...
public class LoanTest {
	...
	public static void setUpBeforeClass() throws Exception {
		Book b1= new Book("akashdeep", "Welcome to JUnit testing", "123456", 9999);
		Book b2= new Book("akashdeep", "Welcome to JUnit testing", "123456", 00023);

		Member m1= new Member("akashdeep","sadiora","123456","sunnyohi@gmail.com.com",1234);
	...
	public void testGetID() {
		Member m= new Member("akashdeep","sadiora","123456","sunnyohi@gmail.com",2222);
		int id= m.getID();
